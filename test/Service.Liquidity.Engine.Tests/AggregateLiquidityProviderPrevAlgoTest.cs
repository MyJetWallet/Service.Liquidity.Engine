...
{
    public class AggregateLiquidityProviderPrevAlgoTest : AggregateLiquidityProviderTestBase
    {
        [Test]
        ...
        {
            SetupEnvironment_1();
            _settingsMock.LpSettings.First().Mode = EngineMode.Disabled;
        ...
        {
            SetupEnvironment_1();
            _settingsMock.LpSettings.First().Mode = EngineMode.Idle;
        ...
        {
            SetupEnvironment_1();
            _walletManager.Balances["LP-Wallet"]["BTC"].Balance = 0.7;
        ...
        {
            SetupEnvironment_1();
            _walletManager.Balances["LP-Wallet"]["USD"].Balance = 42058;
        ...
        public async Task Check_Balance_BuySide_RoundDownVolume()
        {
            ...
            _walletManager.Balances["LP-Wallet"]["USD"].Balance = 40057.32;
        ...
        {
            SetupEnvironment_1();
            _settingsMock.LpSettings.First().LpSources.First().Markup = 0.1;
        ...
        {
            SetupEnvironment_1();
            _settingsMock.LpSettings.First().LpSources.First().MaxSellSideVolume = 0.7;
            _settingsMock.LpSettings.First().LpSources.First().MaxBuySideVolume = 0.7;
        ...
        {
            SetupEnvironment_1();
            _walletManager.Balances["LP-Wallet"]["BTC"].Balance = 1;
            _walletManager.Balances["LP-Wallet"]["USD"].Balance = 500000;
        ...
        {
            SetupEnvironment_1();
            _walletManager.Balances["LP-Wallet"]["BTC"].Balance = 5;
            _walletManager.Balances["LP-Wallet"]["USD"].Balance = 0;
        ...
        public async Task Split_OrderBook_ToExternalBalance_Sell_1()
        {
            SetupEnvironment_1();
            _walletManager.Balances["LP-Wallet"]["BTC"].Balance = 5;
            _walletManager.Balances["LP-Wallet"]["USD"].Balance = 1000000;
        ...
        {
            SetupEnvironment_1();
            _settingsMock.LpSettings[0].LpSources.First().MaxBuySideVolume = 0.1;
